...
const tourSchema = new mongoose.Schema(
  {
    ...
    ratingsAverage: {
      ...
      // (val * 10) will give for example 46.666 and dividing by 10 will give 4.7 rounded value
...
/* Creating our own index. Here 1 means in ascending order and -1 means descending */
...
/* Used only for testing post find middleware */
