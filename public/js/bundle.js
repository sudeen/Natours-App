...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1Ijoic3VkZWVuIiwiYSI6ImNrNm04ZGNjeTBuNjczanBjNXV6MzExOHIifQ.e5LHDDS1Hzso3Lis8OxBKQ';
  var map = new mapboxgl.Map({
    container: 'map',
    style: 'mapbox://styles/sudeen/ck6m8kviv07m81ip2dpsxw9or',
    scrollZoom: false //   center: [-118.113491, 34.111745], // First longitude and then lattitude
    //   zoom: 4,
    //   interactive: false
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 7:
            ...
            (0, _alerts.showAlert)('error', _context.t0.response.data.message); // console.log(err);
...
// This helps to work some of the newer javascript function to work in older browsers
// DOM ELEMENTS
